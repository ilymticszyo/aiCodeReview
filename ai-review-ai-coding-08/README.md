...
## 关于本仓库
📚 本仓库是冰河技术知识星球推出的基于AI大模型的Code-Review项目，内置支持多种AI大模型，例如：deepseek、千问、智谱、openai等等，也可以快速扩展定义其他AI大模型，内置多种不同语言的优秀提示词，可支持对Java、Python、PHP、Yaml、Vue、Go、C、C++、JS、CSS、MD、SQL、TS、TSX、JSX等不同类型的语言和文件进行Review，对Review结果进行评分，深度剖析存在的问题和修复方案，并对整体代码优化给出建设性建议，并对整体结果进行持久化存储，可供长期分析代码质量。代码仓库支持GitHub、Gitee和GitLab等，可直接对接钉钉、微信、飞书等推送消息，也可快速扩展自定义对接其他平台，整体项目可直接应用于实际CR场景中。
...
冰河技术知识星球推出的基于AI大模型的Code-Review项目，内置支持多种AI大模型，例如：deepseek、千问、智谱、openai等等，也可以快速扩展定义其他AI大模型，内置多种不同语言的优秀提示词，可支持对Java、Python、PHP、Yaml、Vue、Go、C、C++、JS、CSS、MD、SQL、TS、TSX、JSX等不同类型的语言和文件进行Review，对Review结果进行评分，深度剖析存在的问题和修复方案，并对整体代码优化给出建设性建议，并对整体结果进行持久化存储，可供长期分析代码质量。代码仓库支持GitHub、Gitee和GitLab等，可直接对接钉钉、微信、飞书等推送消息，也可快速扩展自定义对接其他平台，整体项目可直接应用于实际CR场景中。
